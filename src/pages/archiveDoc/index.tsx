...
const ArchiveDoc = () => {
 ...
 console.log(messageApi, editable, isLoading, setSum)
      ...
      >
        ...
        >
          <Select
            ...
            disabled={true}
          >
            <Select.Option readOnly={true} value="01">Платежное поручение</Select.Option>
            <Select.Option readOnly={true} value="06">Мемориальный ордер</Select.Option>
          </Select>
          ...
          >
            ...
            <div>
              ...
              <Form.Item
                ...
                name="debitName"
              >
                <Input style={{ width: 400, display: "flex" }} disabled={true}/>
              </Form.Item>
              <Form.Item
            ...
            >
              <Input maxLength={5} style={{ width: 400, display: "flex" }} disabled={true}/>
            </Form.Item>
          </div>
        ...
        >
          <TextArea rows={4} style={{ width: "80%", display: "flex" }} disabled={true} />
        </Form.Item>
